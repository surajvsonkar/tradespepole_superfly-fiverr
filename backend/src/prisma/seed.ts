...
async function main() {
  ...
  const tradesperson1 = await prisma.user.create({
    data: {
      name: 'David Wilson',
  ...
  const tradesperson2 = await prisma.user.create({
    data: {
      name: 'Emma Thompson',
  ...
  const tradesperson3 = await prisma.user.create({
    data: {
      name: 'James Anderson',
  ...
  const tradesperson4 = await prisma.user.create({
    data: {
  ...
  const tradesperson5 = await prisma.user.create({
    data: {
      name: 'Oliver Davis',
  ...
  const jobLead1 = await prisma.jobLead.create({
    data: {
  ...
  const jobLead2 = await prisma.jobLead.create({
    data: {
  ...
  const jobLead3 = await prisma.jobLead.create({
    data: {
  ...
  const jobLead4 = await prisma.jobLead.create({
    data: {
  ...
  const jobLead5 = await prisma.jobLead.create({
    data: {
  ...
  const quoteRequest3 = await prisma.quoteRequest.create({
    data: {
